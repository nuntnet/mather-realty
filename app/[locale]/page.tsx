  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(to bottom right, rgba(30,58,138,0.82), rgba(30,64,175,0.72), rgba(67,56,202,0.62)), url('https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=1920&q=80')",
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center w-full py-24">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-10 drop-shadow">
            {t('hero_subtitle')}
          </p>
          ...
          {/* Trust badges */}
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-blue-100 mb-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <div className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-xl px-6 py-3 text-center min-w-[120px]">
              <p className="text-2xl font-bold">2</p>
              <p className="text-xs text-blue-200 mt-0.5">Active Listings</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-xl px-6 py-3 text-center min-w-[120px]">
              <p className="text-2xl font-bold">Bangkok</p>
              <p className="text-xs text-blue-200 mt-0.5">Top Location</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-xl px-6 py-3 text-center min-w-[120px]">
              <p className="text-2xl font-bold">100%</p>
              <p className="text-xs text-blue-200 mt-0.5">Verified</p>
            </div>
          </div>
        </div>
      </section>
