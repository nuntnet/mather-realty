...
export const metadata: Metadata = {
  ...
  description: 'Learn about DoubleN Realty — your trusted partner for rental properties in Thailand.',
}
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">About DoubleN Realty</h1>
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          <p>
            DoubleN Realty specialises in helping expats and foreigners find their perfect rental
