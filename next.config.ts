...
const securityHeaders = [
  ...
  // Basic CSP — allows Google Maps, YouTube, Cloudinary, LINE, Notion
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: res.cloudinary.com *.notion.so images.unsplash.com *.s3.amazonaws.com *.cloudfront.net *.amazonaws.com img.youtube.com files.manuscdn.com d2xsxph8kpxj0f.cloudfront.net www.gwm.co.th www.kia.com www.mitsubishi-motors.co.th www.ford.co.th www.changan.co.th upload.wikimedia.org",
...
const nextConfig: NextConfig = {
  images: {
    ...
    remotePatterns: [
      ...
      { protocol: "https", hostname: "micro-site-cms.s3.ap-southeast-1.amazonaws.com" },
      ...
      { protocol: "https", hostname: "www.ford.co.th" },
