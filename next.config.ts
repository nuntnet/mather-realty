...
const nextConfig: NextConfig = {
  images: {
    ...
    remotePatterns: [
      ...
      { protocol: "https", hostname: "mazda-media-s3.s3.amazonaws.com" },
      { protocol: "https", hostname: "imgcdn.zigwheels.co.th" },
      { protocol: "https", hostname: "www.mitsubishi-motors.com" },
